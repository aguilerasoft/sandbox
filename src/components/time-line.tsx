                    ...
                    {dataAboutPage.map((data) => (
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                            ...
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                ...
                                <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center justify-center text-2xl font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-[#ffff] bg-[#2098CC] rounded-full">{data.date}</time>
