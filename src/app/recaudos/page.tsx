    ...
    <>
      ...
      <h1 className="text-2xl leading-tight text-center md:text-left md:text-5xl">
        ...
        <RecaudosComponente
          ...
          gradientFrom="#09141a"
          gradientTo="#2584C8"
          content="Si es persona natural, nombre y apellido, cédula de identidad, pasaporte, registro único de información fiscal (RIF), teléfono principal, fecha de nacimiento, nacionalidad, estado civil, dirección de habitación, correo electrónico principal."
        />
        <RecaudosComponente
